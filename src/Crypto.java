...
//    private static String encode_using_xor(final byte[] input, final byte[] secret) {
...
//    private static String decode_operation(String s,final byte[] key){
//        int spos = 0;
//        try{
...
/*output :
 * Original String : encode me £µé#^^]@12&~#{[,?-yassinefadhlaoui-engeneer
String after encrytion :  Iw8HBwgETxgMEvGW9d6m0EUxLAUPQ1dIHVEiK1hWQhcnEhcBAgQJFA1aX1RYHgxUAwEVPSEXABw=
String after decrytion :  encode me £µé#^^]@12&~#{[,?-yassinefadhlaoui-engeneer
*/
